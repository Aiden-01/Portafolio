  ...
  return (
    <div className="container my-5 py-5">
      ...
      <section className="text-center mb-5 pb-4 border-bottom">
        <h1 className="display-4 fw-bold text-primary mb-3 animate__animated animate__fadeInDown">
          ¡Hola! Soy <span className="text-secondary">Hugo Corado</span>, un Desarrollador Web
          <br className="d-none d-md-block" />
          con una Pasión por la Innovación.
        </h1>
        <p className="lead text-muted mb-4 animate__animated animate__fadeInUp">
        ...
        <p className="fs-5 text-dark animate__animated animate__fadeInUp">
